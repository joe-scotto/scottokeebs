...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_4x10(
        ...
        KC_ESC,       KC_NO, KC_LCTL, KC_LALT, LGUI_T(KC_SPC), LT(1, KC_TAB), LT(2, KC_ENT), TD(TD_ESC_SPOTLIGHT_EMOJI), KC_NO,  KC_NO
    ),
    [1] = LAYOUT_ortho_4x10(
    ...
    [4] = LAYOUT_ortho_4x10(
        ...
        KC_A,         KC_R,  KC_S,    KC_T,    KC_D,   KC_H,          KC_N,          KC_E,                     KC_I,   KC_O,
        LSFT_T(KC_Z), KC_X,  KC_C,    KC_V,    KC_B,   KC_K,          KC_M,          KC_COMMA,                 KC_DOT, RSFT_T(KC_SLSH),
        KC_ESC,       KC_NO, KC_LCTL, KC_LALT, KC_SPC, LT(5, KC_TAB), LT(6, KC_ENT), TD(TD_ESC_WINDOWS_EMOJI), KC_NO,  KC_NO
    ),
    [5] = LAYOUT_ortho_4x10(
        KC_UNDS,         KC_MINS, KC_PLUS, KC_EQL,  KC_COLN, KC_GRV,   KC_MRWD, KC_MPLY, KC_MFFD, KC_DEL,
        KC_LCBR,         KC_LPRN, KC_RPRN, KC_RCBR, KC_PIPE, KC_ESC,   KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT,
