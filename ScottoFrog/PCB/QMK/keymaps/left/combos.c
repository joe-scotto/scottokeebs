...
const uint16_t PROGMEM special_number_esc[] = {TO(0), KC_KP_MINUS, COMBO_END};
...
const uint16_t PROGMEM special_number_home[] = {TO(0), KC_9, COMBO_END};
...
const uint16_t PROGMEM special_number_pause[] = {TO(0), KC_7, COMBO_END};
...
const uint16_t PROGMEM special_number_page_up[] = {TO(0), KC_KP_ASTERISK, COMBO_END};
...
const uint16_t PROGMEM special_number_insert[] = {TO(0), KC_KP_PLUS, COMBO_END};
...
const uint16_t PROGMEM special_number_ctrl[] = {TO(0), KC_6, COMBO_END};
...
const uint16_t PROGMEM special_number_up[] = {TO(0), KC_4, COMBO_END};
...
const uint16_t PROGMEM special_number_page_down[] = {TO(0), KC_KP_SLASH, COMBO_END};
...
const uint16_t PROGMEM special_number_delete[] = {TO(0), KC_EQUAL, COMBO_END};
...
const uint16_t PROGMEM special_number_backspace[] = {TO(0), KC_3, COMBO_END};
const uint16_t PROGMEM special_symbol_backspace[] = {TO(1), KC_LEFT_ANGLE_BRACKET, COMBO_END};
const uint16_t PROGMEM special_base_right[] = {TO(1), KC_N, COMBO_END};
const uint16_t PROGMEM special_number_right[] = {TO(0), KC_2, COMBO_END};
const uint16_t PROGMEM special_symbol_right[] = {TO(1), KC_LEFT_PAREN, COMBO_END};
const uint16_t PROGMEM special_base_down[] = {TO(1), KC_S, COMBO_END};
const uint16_t PROGMEM special_number_down[] = {TO(0), KC_1, COMBO_END};
