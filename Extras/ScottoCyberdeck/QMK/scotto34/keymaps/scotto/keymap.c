...
enum {
    TD_ESC_LCTL_LALT_WINDOWS
};

// Custom tapping term for multi function keys
uint16_t get_tapping_term(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case TD(TD_ESC_LCTL_LALT_WINDOWS) :
        case LGUI_T(KC_SPC) :
        case LT(1, KC_SPC) :
        case LT(1, KC_TAB) :
        case LT(2, KC_ENT) :
...
void td_esc_lctl_lalt_windows_finished(tap_dance_state_t *state, void *user_data) {
...
void td_esc_lctl_lalt_windows_reset(tap_dance_state_t *state, void *user_data) {
    switch (xtap_state.state) {
...
tap_dance_action_t tap_dance_actions[] = {
    [TD_ESC_LCTL_LALT_WINDOWS] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, td_esc_lctl_lalt_windows_finished, td_esc_lctl_lalt_windows_reset)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_2(
        ...
        LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B,                         KC_K,           KC_M,          KC_COMMA,     KC_DOT, RSFT_T(KC_SLSH),
                                  TD(TD_ESC_LCTL_LALT_WINDOWS), LCTL_T(KC_SPC), LT(2, KC_TAB), LT(3, KC_ENT)
    ),
    ...
    [3] = LAYOUT_split_3x5_2(
        ...
        KC_LSFT, KC_NO, KC_NO,   KC_NO,   MO(4),   KC_NO,   KC_NO,   KC_COMM, KC_DOT,  RSFT_T(KC_SLSH),
                                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [4] = LAYOUT_split_3x5_2(
        KC_NO,  KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO, TO(1), TO(0), KC_NO,
