...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_LGUI_ESC_SPOTLIGHT_EMOJI] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, td_ent_lgui_lctl_spotlight_emoji_finished, td_ent_lgui_lctl_spotlight_emoji_reset)
};