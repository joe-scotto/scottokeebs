...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_3x10_5(
        KC_1,         KC_2,    KC_3,    KC_4,    KC_5,           KC_6,          KC_7,          KC_8,          KC_9,   KC_0,    KC_BKSP
        KC_Q,         KC_W,    KC_E,    KC_R,    KC_T,           KC_Y,          KC_U,          KC_I,          KC_O,   KC_P,    KC_BKSP
        KC_A,         KC_S,    KC_D,    KC_F,    KC_G,           KC_H,          KC_J,          KC_K,          KC_L,   KC_SCLN, 
        LSFT_T(KC_Z), KC_X,    KC_C,    KC_V,    KC_B,           KC_N,          KC_M,          KC_COMMA,      KC_DOT, RSFT_T(KC_SLSH),
        KC_LCTL,      KC_LGUI, KC_LALT           KC_SPC,         LT(1, KC_TAB), LT(2, KC_ENT)
    ),
    [1] = LAYOUT_ortho_3x10_5(
        ...
        LSFT_T(KC_LBRC), KC_QUOT, KC_DQUO, KC_RBRC, KC_SCLN,        KC_TILDE, KC_VOLD, KC_MUTE, KC_VOLU, RSFT_T(KC_BSLS),
                         KC_LCTL, KC_LALT,          LGUI_T(KC_SPC),           KC_TRNS, KC_TRNS
    ),
