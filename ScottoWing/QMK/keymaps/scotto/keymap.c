...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT_split_3x6_2(
        KC_TRNS, KC_Q,         KC_W, KC_F, KC_P,                               KC_G,           KC_J,          KC_L,         KC_U,     KC_Y,   KC_BSPC,         KC_TRNS,
        KC_TRNS, KC_A,         KC_R, KC_S, KC_T,                               KC_D,           KC_H,          KC_N,         KC_E,     KC_I,   KC_O,            KC_TRNS,
        KC_TRNS, LSFT_T(KC_Z), KC_X, KC_C, KC_V,                               KC_B,           KC_K,          KC_M,         KC_COMMA, KC_DOT, RSFT_T(KC_SLSH), KC_TRNS,
                                           TD(TD_ESC_LCTL_LALT_WINDOWS_EMOJI), LCTL_T(KC_SPC), LT(6, KC_TAB), LT(7, KC_ENT)
    ),
    [5] = LAYOUT_split_3x6_2(
        KC_TRNS, KC_Q, KC_W, KC_F, KC_P,    KC_G,   KC_J,          KC_L,         KC_U,     KC_Y,   KC_BSPC, KC_TRNS,
        KC_TRNS, KC_A, KC_R, KC_S, KC_T,    KC_D,   KC_H,          KC_N,         KC_E,     KC_I,   KC_O,    KC_TRNS,
        KC_TRNS, KC_Z, KC_X, KC_C, KC_V,    KC_B,   KC_K,          KC_M,         KC_COMMA, KC_DOT, KC_SLSH, KC_TRNS,
                                   KC_LCTL, KC_SPC, LT(6, KC_TAB), LT(7, KC_ENT)
    ),
    [6] = LAYOUT_split_3x6_2(
        KC_TRNS, KC_UNDS,         KC_MINS, KC_PLUS, KC_EQL,  KC_COLN, KC_GRV,   KC_MRWD, KC_MPLY, KC_MFFD, KC_DEL,          KC_TRNS,
        KC_TRNS, KC_LCBR,         KC_LPRN, KC_RPRN, KC_RCBR, KC_PIPE, KC_ESC,   KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT,         KC_TRNS,
        KC_TRNS, LSFT_T(KC_LBRC), KC_QUOT, KC_DQUO, KC_RBRC, KC_SCLN, KC_TILDE, KC_VOLD, KC_MUTE, KC_VOLU, RSFT_T(KC_BSLS), KC_TRNS,
                                                    KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS
    ),
    [7] = LAYOUT_split_3x6_2(
        KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_CAPS, KC_BSPC,         KC_TRNS,
        KC_TRNS, KC_1,    KC_2,  KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,            KC_TRNS,
        KC_TRNS, KC_LSFT, KC_NO, KC_NO,   KC_NO,   MO(8),   KC_NO,   KC_NO,   KC_COMM, KC_DOT,  RSFT_T(KC_SLSH), KC_TRNS,
                                          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [8] = LAYOUT_split_3x6_2(
