...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_3x10_7(
        ...
        KC_ESC,             KC_LCTL, KC_LALT, LGUI_T(KC_SPC),       LT(1, KC_TAB), LT(2, KC_ENT),         KC_RSFT
    ),
    [1] = LAYOUT_ortho_3x10_7(
        ...
        KC_ESC,                   KC_LCTL, KC_LALT, LGUI_T(KC_SPC),           KC_TRNS, KC_TRNS,          KC_RSFT 
    ),
    [2] = LAYOUT_ortho_3x10_7(
        ...
        KC_ESC,         KC_LCTL, KC_LALT, LGUI_T(KC_SPC), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_RSFT 
    ),
    [3] = LAYOUT_ortho_3x10_7(
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,          KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, 
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,          KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,
        KC_F11,  KC_NO,   KC_NO,   QK_BOOT, KC_TRNS,        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_F12,
        KC_ESC, KC_TRNS, KC_LCTL, KC_LALT, LGUI_T(KC_SPC), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_RSFT 
    )
};
