...
//    ├────────────┼───────────────┼───┼──────────────┼─────────────┼────────────┼────────────┼────┼───────────┼───────────┤
//    │ LT(5, esc) │       k       │ j │ TD(TD_MULTI) │ LGUI_T(spc) │ LT(2, tab) │ LT(3, ent) │ no │    no     │    no     │
//    └────────────┴───────────────┴───┴──────────────┴─────────────┴────────────┴────────────┴────┴───────────┴───────────┘
[0] = LAYOUT_ortho_4x10(
  KC_Q          , KC_W          , KC_F , KC_P         , KC_G           , KC_J          , KC_L          , KC_U     , KC_Y           , KC_BSPC        ,
  KC_A          , KC_R          , KC_S , KC_T         , KC_D           , KC_H          , KC_N          , KC_E     , KC_I           , KC_O           ,
  LSFT_T(KC_Z)  , TD(TD_MODS_X) , KC_C , KC_V         , KC_B           , KC_K          , KC_M          , KC_COMMA , RGUI_T(KC_DOT) , RSFT_T(KC_SLSH),
  LT(5, KC_ESC) , KC_K          , KC_J , TD(TD_MULTI) , LGUI_T(KC_SPC) , LT(2, KC_TAB) , LT(3, KC_ENT) , KC_NO    , KC_NO          , KC_NO
),
...
[1] = LAYOUT_ortho_4x10(
  ...
  KC_TRNS , KC_K , KC_J , KC_RCTL , KC_SPC , KC_TRNS , KC_TRNS , KC_TRNS  , KC_TRNS , KC_TRNS
),
