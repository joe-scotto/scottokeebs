...
//    ├──────┼───────────┼───────────────┼──────┼──────────────┼─────────────┤       ├───────────────┼─────────────────┼──────┼───────────┼───────────┼──────┤
//    │ esc  │   rgui    │     ralt      │ rctl │ TD(TD_MULTI) │ LGUI_T(spc) │       │ LT(CODE, tab) │ LT(NUMBER, ent) │ left │    up     │   down    │ rght │
//    └──────┴───────────┴───────────────┴──────┴──────────────┴─────────────┘       └───────────────┴─────────────────┴──────┴───────────┴───────────┴──────┘
[BASE] = LAYOUT_ortho_4x12(
  ...
  KC_ESC  , KC_RGUI      , KC_RALT       , KC_RCTL , TD(TD_MULTI) , LGUI_T(KC_SPC) ,         LT(CODE, KC_TAB) , LT(NUMBER, KC_ENT) , KC_LEFT  , KC_UP          , KC_DOWN         , KC_RIGHT
),
...
[GAME] = LAYOUT_ortho_4x12(
  ...
  KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,         KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS,
  KC_TRNS , KC_Z    , KC_X    , KC_TRNS , KC_TRNS , KC_TRNS ,         KC_TRNS , KC_TRNS , KC_TRNS , KC_DOT  , KC_SLSH , KC_TRNS,
  KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_RCTL , KC_SPC  ,         KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS
),
